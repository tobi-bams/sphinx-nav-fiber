import{r as o,j as e,s as h,g as k,F as j,o as J,c as K,A as ae,p as ce,i as le,q as pe,H as de,t as ue,v as X}from"./index-046b05f8.js";import{t as V,u as H,C as fe}from"./index-34c0fa8a.js";import{U as me}from"./index-4cbbe819.js";import{u as B,a as ge,b as he,I as xe,c as Q,d as ye}from"./index-e3b245b0.js";import{M as be,V as we}from"./index-a9d6429c.js";import{S as je,R as ve,s as L,M as ke}from"./index-1ddefa3c.js";import"./string-a277709d.js";import"./index-263c5edc.js";import"./three.module-9722a9fc.js";import"./index-b6a98c48.js";import"./TextareaAutosize-6fbba815.js";import"./CheckIcon-5d3146c3.js";import"./index-d7c4dcde.js";import"./index-60b03a6d.js";import"./ClipLoader-a59b93a2.js";import"./clsx-11525a77.js";import"./SourcesTableIcon-e2514ef7.js";import"./DeleteNodeIcon-bc60dc86.js";import"./SoundIcon-35a91b5f.js";import"./SucessFeedBackIcon-8dceab1b.js";import"./Skeleton-3d4174af.js";import"./index-7539669b.js";import"./Stack-c9e650f5.js";import"./FormControlLabel-4639ace1.js";import"./Typography-e4f317a7.js";import"./createSvgIcon-ebea312f.js";import"./isPlainObject-de3c7b36.js";const Z=o.memo(()=>{const s=B(r=>r.isPlaying),i=B(r=>r.setIsPlaying),n=B(r=>r.setVolume),t=B(r=>r.setPlaybackSpeed),a=B(r=>r.playbackSpeed),c=B(r=>r.playerRef),[f,m]=o.useState(!1),p=[.5,1,1.5,2],y=()=>{if(c){const r=c.getCurrentTime()-15;c.seekTo(r,"seconds")}},g=()=>{if(c){const r=c.getCurrentTime()+15;c.seekTo(r,"seconds")}},b=()=>{i(!s)},d=()=>{m(!f),n(f?1:0)},x=()=>{const u=(p.indexOf(a)+1)%p.length,w=p[u];if(t(w),c){const v=c.getInternalPlayer();v&&typeof v.playbackRate<"u"&&(v.playbackRate=w)}};return e.jsxs(Ce,{children:[e.jsx(Pe,{onClick:d,children:f?e.jsx(be,{}):e.jsx(we,{})}),e.jsx(_e,{onClick:y,children:e.jsx("img",{alt:"",src:"/RewindIcon.svg"})}),e.jsx(Se,{"data-testid":"play-pause-button",onClick:b,size:"small",children:s?e.jsx(ge,{"data-testid":"pause-icon"}):e.jsx(he,{"data-testid":"play-icon"})}),e.jsx(Ie,{onClick:g,children:e.jsx("img",{alt:"",src:"/ForwardIcon.svg"})}),e.jsxs(Ee,{onClick:x,children:[a,"x"]})]})});Z.displayName="Controls";const Ce=h(j).attrs({direction:"row",align:"center",justify:"flex-start"})`
  width: 200px;
  height: 54px;
  background: ${k.BG1};
  border-radius: 40px;
