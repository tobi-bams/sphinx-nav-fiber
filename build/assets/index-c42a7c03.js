import{r as o,j as e,s as h,g as k,F as j,o as J,c as K,A as ae,p as ce,i as le,q as pe,H as de,t as ue,v as X}from"./index-cc66b035.js";import{t as V,u as H,C as fe}from"./index-103a29c0.js";import{U as me}from"./index-34a53cdd.js";import{u as B,a as ge,b as he,I as xe,c as Q,d as ye}from"./index-dc6f3627.js";import{M as be,V as we}from"./index-fcbe6aeb.js";import{S as je,R as ve,s as L,M as ke}from"./index-39eb5fb7.js";import"./string-a277709d.js";import"./index-ba7419ed.js";import"./three.module-9722a9fc.js";import"./index-3b4d7f87.js";import"./TextareaAutosize-27ff2a12.js";import"./CheckIcon-c56956e1.js";import"./index-31b4ff31.js";import"./index-41a88932.js";import"./ClipLoader-da98ed7e.js";import"./clsx-252e76be.js";import"./SourcesTableIcon-803eafa9.js";import"./DeleteNodeIcon-34557c39.js";import"./SoundIcon-9dfac8d5.js";import"./SucessFeedBackIcon-7974ad00.js";import"./Skeleton-76772401.js";import"./index-bcc57abc.js";import"./Stack-ac6ff859.js";import"./FormControlLabel-069f03ea.js";import"./Typography-e72ff0ab.js";import"./createSvgIcon-9a8872a2.js";import"./isPlainObject-bfc9e9a9.js";const Z=o.memo(()=>{const s=B(r=>r.isPlaying),i=B(r=>r.setIsPlaying),n=B(r=>r.setVolume),t=B(r=>r.setPlaybackSpeed),a=B(r=>r.playbackSpeed),c=B(r=>r.playerRef),[f,m]=o.useState(!1),p=[.5,1,1.5,2],y=()=>{if(c){const r=c.getCurrentTime()-15;c.seekTo(r,"seconds")}},g=()=>{if(c){const r=c.getCurrentTime()+15;c.seekTo(r,"seconds")}},b=()=>{i(!s)},d=()=>{m(!f),n(f?1:0)},x=()=>{const u=(p.indexOf(a)+1)%p.length,w=p[u];if(t(w),c){const v=c.getInternalPlayer();v&&typeof v.playbackRate<"u"&&(v.playbackRate=w)}};return e.jsxs(Ce,{children:[e.jsx(Pe,{onClick:d,children:f?e.jsx(be,{}):e.jsx(we,{})}),e.jsx(_e,{onClick:y,children:e.jsx("img",{alt:"",src:"/RewindIcon.svg"})}),e.jsx(Se,{"data-testid":"play-pause-button",onClick:b,size:"small",children:s?e.jsx(ge,{"data-testid":"pause-icon"}):e.jsx(he,{"data-testid":"play-icon"})}),e.jsx(Ie,{onClick:g,children:e.jsx("img",{alt:"",src:"/ForwardIcon.svg"})}),e.jsxs(Ee,{onClick:x,children:[a,"x"]})]})});Z.displayName="Controls";const Ce=h(j).attrs({direction:"row",align:"center",justify:"flex-start"})`
  width: 200px;
  height: 54px;
  background: ${k.BG1};
  border-radius: 40px;
