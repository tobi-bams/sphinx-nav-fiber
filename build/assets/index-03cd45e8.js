import{r as o,j as e,s as h,g as k,F as j,o as J,c as K,A as ae,p as ce,i as le,q as pe,H as de,t as ue,v as X}from"./index-973f2530.js";import{t as V,u as H,C as fe}from"./index-a269b6ca.js";import{U as me}from"./index-46d0223a.js";import{u as B,a as ge,b as he,I as xe,c as Q,d as ye}from"./index-19d35958.js";import{M as be,V as we}from"./index-0664c174.js";import{S as je,R as ve,s as L,M as ke}from"./index-c7d5df44.js";import"./string-a277709d.js";import"./index-a430e93f.js";import"./three.module-9722a9fc.js";import"./index-92793de5.js";import"./TextareaAutosize-cedf3327.js";import"./CheckIcon-64cce038.js";import"./index-bddfee7b.js";import"./index-0c86b474.js";import"./ClipLoader-44a18e10.js";import"./clsx-e70c9a3b.js";import"./SourcesTableIcon-c654332b.js";import"./DeleteNodeIcon-e3bc2dd1.js";import"./SoundIcon-30a2ed5e.js";import"./SucessFeedBackIcon-9ff4be97.js";import"./Skeleton-9d9e8814.js";import"./index-5c9ed78b.js";import"./Stack-6ae1031a.js";import"./FormControlLabel-e9af0c39.js";import"./Typography-eee2815b.js";import"./createSvgIcon-0a6f3d51.js";import"./isPlainObject-4ea45d66.js";const Z=o.memo(()=>{const s=B(r=>r.isPlaying),i=B(r=>r.setIsPlaying),n=B(r=>r.setVolume),t=B(r=>r.setPlaybackSpeed),a=B(r=>r.playbackSpeed),c=B(r=>r.playerRef),[f,m]=o.useState(!1),p=[.5,1,1.5,2],y=()=>{if(c){const r=c.getCurrentTime()-15;c.seekTo(r,"seconds")}},g=()=>{if(c){const r=c.getCurrentTime()+15;c.seekTo(r,"seconds")}},b=()=>{i(!s)},d=()=>{m(!f),n(f?1:0)},x=()=>{const u=(p.indexOf(a)+1)%p.length,w=p[u];if(t(w),c){const v=c.getInternalPlayer();v&&typeof v.playbackRate<"u"&&(v.playbackRate=w)}};return e.jsxs(Ce,{children:[e.jsx(Pe,{onClick:d,children:f?e.jsx(be,{}):e.jsx(we,{})}),e.jsx(_e,{onClick:y,children:e.jsx("img",{alt:"",src:"/RewindIcon.svg"})}),e.jsx(Se,{"data-testid":"play-pause-button",onClick:b,size:"small",children:s?e.jsx(ge,{"data-testid":"pause-icon"}):e.jsx(he,{"data-testid":"play-icon"})}),e.jsx(Ie,{onClick:g,children:e.jsx("img",{alt:"",src:"/ForwardIcon.svg"})}),e.jsxs(Ee,{onClick:x,children:[a,"x"]})]})});Z.displayName="Controls";const Ce=h(j).attrs({direction:"row",align:"center",justify:"flex-start"})`
  width: 200px;
  height: 54px;
  background: ${k.BG1};
  border-radius: 40px;
