import{r as o,j as e,s as h,g as k,F as j,o as J,c as K,A as ae,p as ce,i as le,q as pe,H as de,t as ue,v as X}from"./index-1069599b.js";import{t as V,u as H,C as fe}from"./index-f3974fab.js";import{U as me}from"./index-b3c4ac8d.js";import{u as B,a as ge,b as he,I as xe,c as Q,d as ye}from"./index-3a4c6a5d.js";import{M as be,V as we}from"./index-aac187bb.js";import{S as je,R as ve,s as L,M as ke}from"./index-5f7305c1.js";import"./string-a277709d.js";import"./index-03cb067d.js";import"./three.module-9722a9fc.js";import"./index-a1ec0f39.js";import"./TextareaAutosize-8ddefca4.js";import"./CheckIcon-60d18cda.js";import"./index-5070bba2.js";import"./index-4f0543c5.js";import"./ClipLoader-015e7281.js";import"./clsx-c34afb36.js";import"./SourcesTableIcon-cfb8bbef.js";import"./DeleteNodeIcon-9b22b01b.js";import"./SoundIcon-12d100ca.js";import"./SucessFeedBackIcon-f65531e7.js";import"./Skeleton-b1b2bf3e.js";import"./index-78e28c7f.js";import"./Stack-103b9e5c.js";import"./FormControlLabel-87b8d94e.js";import"./Typography-15f81f3e.js";import"./createSvgIcon-3a0825e6.js";import"./isPlainObject-f2ad0125.js";const Z=o.memo(()=>{const s=B(r=>r.isPlaying),i=B(r=>r.setIsPlaying),n=B(r=>r.setVolume),t=B(r=>r.setPlaybackSpeed),a=B(r=>r.playbackSpeed),c=B(r=>r.playerRef),[f,m]=o.useState(!1),p=[.5,1,1.5,2],y=()=>{if(c){const r=c.getCurrentTime()-15;c.seekTo(r,"seconds")}},g=()=>{if(c){const r=c.getCurrentTime()+15;c.seekTo(r,"seconds")}},b=()=>{i(!s)},d=()=>{m(!f),n(f?1:0)},x=()=>{const u=(p.indexOf(a)+1)%p.length,w=p[u];if(t(w),c){const v=c.getInternalPlayer();v&&typeof v.playbackRate<"u"&&(v.playbackRate=w)}};return e.jsxs(Ce,{children:[e.jsx(Pe,{onClick:d,children:f?e.jsx(be,{}):e.jsx(we,{})}),e.jsx(_e,{onClick:y,children:e.jsx("img",{alt:"",src:"/RewindIcon.svg"})}),e.jsx(Se,{"data-testid":"play-pause-button",onClick:b,size:"small",children:s?e.jsx(ge,{"data-testid":"pause-icon"}):e.jsx(he,{"data-testid":"play-icon"})}),e.jsx(Ie,{onClick:g,children:e.jsx("img",{alt:"",src:"/ForwardIcon.svg"})}),e.jsxs(Ee,{onClick:x,children:[a,"x"]})]})});Z.displayName="Controls";const Ce=h(j).attrs({direction:"row",align:"center",justify:"flex-start"})`
  width: 200px;
  height: 54px;
  background: ${k.BG1};
  border-radius: 40px;
