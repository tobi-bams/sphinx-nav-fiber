import{r as o,j as e,s as h,g as k,F as j,o as J,c as K,A as ae,p as ce,i as le,q as pe,H as de,t as ue,v as X}from"./index-2994430f.js";import{t as V,u as H,C as fe}from"./index-4c2191f9.js";import{U as me}from"./index-ac867a57.js";import{u as B,a as ge,b as he,I as xe,c as Q,d as ye}from"./index-f62b0b4a.js";import{M as be,V as we}from"./index-7824c2b2.js";import{S as je,R as ve,s as L,M as ke}from"./index-ebddb8b0.js";import"./string-a277709d.js";import"./index-0cad5ac3.js";import"./three.module-9722a9fc.js";import"./index-77d92498.js";import"./TextareaAutosize-fb881ec6.js";import"./CheckIcon-085d17bb.js";import"./index-aeb9b8a3.js";import"./index-8a5b7fd2.js";import"./ClipLoader-b7182946.js";import"./clsx-d0903b76.js";import"./SourcesTableIcon-99793f8d.js";import"./DeleteNodeIcon-87d9c9a9.js";import"./SoundIcon-5f345156.js";import"./SucessFeedBackIcon-5672a4b9.js";import"./Skeleton-f70a0e0c.js";import"./index-b6e5cd88.js";import"./Stack-e8547d3f.js";import"./FormControlLabel-3a38671d.js";import"./Typography-a1a02ea9.js";import"./createSvgIcon-950c5273.js";import"./isPlainObject-9c9fafee.js";const Z=o.memo(()=>{const s=B(r=>r.isPlaying),i=B(r=>r.setIsPlaying),n=B(r=>r.setVolume),t=B(r=>r.setPlaybackSpeed),a=B(r=>r.playbackSpeed),c=B(r=>r.playerRef),[f,m]=o.useState(!1),p=[.5,1,1.5,2],y=()=>{if(c){const r=c.getCurrentTime()-15;c.seekTo(r,"seconds")}},g=()=>{if(c){const r=c.getCurrentTime()+15;c.seekTo(r,"seconds")}},b=()=>{i(!s)},d=()=>{m(!f),n(f?1:0)},x=()=>{const u=(p.indexOf(a)+1)%p.length,w=p[u];if(t(w),c){const v=c.getInternalPlayer();v&&typeof v.playbackRate<"u"&&(v.playbackRate=w)}};return e.jsxs(Ce,{children:[e.jsx(Pe,{onClick:d,children:f?e.jsx(be,{}):e.jsx(we,{})}),e.jsx(_e,{onClick:y,children:e.jsx("img",{alt:"",src:"/RewindIcon.svg"})}),e.jsx(Se,{"data-testid":"play-pause-button",onClick:b,size:"small",children:s?e.jsx(ge,{"data-testid":"pause-icon"}):e.jsx(he,{"data-testid":"play-icon"})}),e.jsx(Ie,{onClick:g,children:e.jsx("img",{alt:"",src:"/ForwardIcon.svg"})}),e.jsxs(Ee,{onClick:x,children:[a,"x"]})]})});Z.displayName="Controls";const Ce=h(j).attrs({direction:"row",align:"center",justify:"flex-start"})`
  width: 200px;
  height: 54px;
  background: ${k.BG1};
  border-radius: 40px;
