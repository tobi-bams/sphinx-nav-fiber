import{s as n,j as e,F as s,b2 as p,b3 as j,B as S,T as i,g as a,D as w,l as y,r as m,b0 as k,b5 as F,n as v,ak as B}from"./index-4dff6362.js";import{S as T}from"./SucessFeedBackIcon-ca85cac6.js";const E=({allowNextStep:r})=>e.jsxs(s,{p:12,children:[e.jsx(s,{align:"center",direction:"row",justify:"space-between",mb:25,children:e.jsx(s,{align:"center",direction:"row",children:e.jsx(z,{children:"Feedback"})})}),e.jsx(s,{mb:30,children:e.jsx(p,{id:"feedback-message",isTextArea:!0,maxLength:500,name:"message",placeholder:"Leave your feedback here ...",rules:j})}),e.jsx(s,{children:e.jsx(S,{color:"secondary","data-testid":"submit-feedback-btn",disabled:!r,size:"large",type:"submit",variant:"contained",children:"Submit"})})]}),z=n(i)`
  font-size: 22px;
  font-weight: 600;
  font-family: 'Barlow';
