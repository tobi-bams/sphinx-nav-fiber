import{r as o,j as e,s as h,g as k,F as j,o as J,c as K,A as ae,p as ce,i as le,q as pe,H as de,t as ue,v as X}from"./index-8f2026e5.js";import{t as V,u as H,C as fe}from"./index-5d6779d8.js";import{U as me}from"./index-10d50993.js";import{u as B,a as ge,b as he,I as xe,c as Q,d as ye}from"./index-4de5a9e4.js";import{M as be,V as we}from"./index-ef010333.js";import{S as je,R as ve,s as L,M as ke}from"./index-111000ad.js";import"./string-a277709d.js";import"./index-5ed20382.js";import"./three.module-9722a9fc.js";import"./index-0b9833ea.js";import"./TextareaAutosize-f6ee6086.js";import"./CheckIcon-dd322c93.js";import"./index-f7ba625a.js";import"./index-23f64e1a.js";import"./ClipLoader-465d0745.js";import"./clsx-cd28c3f0.js";import"./SourcesTableIcon-b3d529b2.js";import"./DeleteNodeIcon-9ab6e8f2.js";import"./SoundIcon-b108644e.js";import"./SucessFeedBackIcon-af2fb8ec.js";import"./Skeleton-fb3042ca.js";import"./index-85f6d3ee.js";import"./Stack-d2e4b3e0.js";import"./FormControlLabel-eff07568.js";import"./Typography-1e068279.js";import"./createSvgIcon-07108b48.js";import"./isPlainObject-24721638.js";const Z=o.memo(()=>{const s=B(r=>r.isPlaying),i=B(r=>r.setIsPlaying),n=B(r=>r.setVolume),t=B(r=>r.setPlaybackSpeed),a=B(r=>r.playbackSpeed),c=B(r=>r.playerRef),[f,m]=o.useState(!1),p=[.5,1,1.5,2],y=()=>{if(c){const r=c.getCurrentTime()-15;c.seekTo(r,"seconds")}},g=()=>{if(c){const r=c.getCurrentTime()+15;c.seekTo(r,"seconds")}},b=()=>{i(!s)},d=()=>{m(!f),n(f?1:0)},x=()=>{const u=(p.indexOf(a)+1)%p.length,w=p[u];if(t(w),c){const v=c.getInternalPlayer();v&&typeof v.playbackRate<"u"&&(v.playbackRate=w)}};return e.jsxs(Ce,{children:[e.jsx(Pe,{onClick:d,children:f?e.jsx(be,{}):e.jsx(we,{})}),e.jsx(_e,{onClick:y,children:e.jsx("img",{alt:"",src:"/RewindIcon.svg"})}),e.jsx(Se,{"data-testid":"play-pause-button",onClick:b,size:"small",children:s?e.jsx(ge,{"data-testid":"pause-icon"}):e.jsx(he,{"data-testid":"play-icon"})}),e.jsx(Ie,{onClick:g,children:e.jsx("img",{alt:"",src:"/ForwardIcon.svg"})}),e.jsxs(Ee,{onClick:x,children:[a,"x"]})]})});Z.displayName="Controls";const Ce=h(j).attrs({direction:"row",align:"center",justify:"flex-start"})`
  width: 200px;
  height: 54px;
  background: ${k.BG1};
  border-radius: 40px;
