import{r as o,j as e,s as h,g as k,F as j,o as J,c as K,A as ae,p as ce,i as le,q as pe,H as de,t as ue,v as X}from"./index-b5f1b91b.js";import{t as V,u as H,C as fe}from"./index-16dfdb08.js";import{U as me}from"./index-aae34f9a.js";import{u as B,a as ge,b as he,I as xe,c as Q,d as ye}from"./index-47de5187.js";import{M as be,V as we}from"./index-90162213.js";import{S as je,R as ve,s as L,M as ke}from"./index-c54c1532.js";import"./string-a277709d.js";import"./index-57e878d0.js";import"./three.module-9722a9fc.js";import"./index-09baf04a.js";import"./TextareaAutosize-557705d2.js";import"./CheckIcon-0fc14237.js";import"./index-63adee55.js";import"./index-f9fade84.js";import"./ClipLoader-b254fccd.js";import"./clsx-2021c788.js";import"./SourcesTableIcon-a3e8ced4.js";import"./DeleteNodeIcon-d05bbe40.js";import"./SoundIcon-3fb82c5b.js";import"./SucessFeedBackIcon-c7853a87.js";import"./Skeleton-ce726539.js";import"./index-87d9ae9e.js";import"./Stack-4294fcd4.js";import"./FormControlLabel-94e24ffc.js";import"./Typography-9873540e.js";import"./createSvgIcon-027caa15.js";import"./isPlainObject-bdf387a4.js";const Z=o.memo(()=>{const s=B(r=>r.isPlaying),i=B(r=>r.setIsPlaying),n=B(r=>r.setVolume),t=B(r=>r.setPlaybackSpeed),a=B(r=>r.playbackSpeed),c=B(r=>r.playerRef),[f,m]=o.useState(!1),p=[.5,1,1.5,2],y=()=>{if(c){const r=c.getCurrentTime()-15;c.seekTo(r,"seconds")}},g=()=>{if(c){const r=c.getCurrentTime()+15;c.seekTo(r,"seconds")}},b=()=>{i(!s)},d=()=>{m(!f),n(f?1:0)},x=()=>{const u=(p.indexOf(a)+1)%p.length,w=p[u];if(t(w),c){const v=c.getInternalPlayer();v&&typeof v.playbackRate<"u"&&(v.playbackRate=w)}};return e.jsxs(Ce,{children:[e.jsx(Pe,{onClick:d,children:f?e.jsx(be,{}):e.jsx(we,{})}),e.jsx(_e,{onClick:y,children:e.jsx("img",{alt:"",src:"/RewindIcon.svg"})}),e.jsx(Se,{"data-testid":"play-pause-button",onClick:b,size:"small",children:s?e.jsx(ge,{"data-testid":"pause-icon"}):e.jsx(he,{"data-testid":"play-icon"})}),e.jsx(Ie,{onClick:g,children:e.jsx("img",{alt:"",src:"/ForwardIcon.svg"})}),e.jsxs(Ee,{onClick:x,children:[a,"x"]})]})});Z.displayName="Controls";const Ce=h(j).attrs({direction:"row",align:"center",justify:"flex-start"})`
  width: 200px;
  height: 54px;
  background: ${k.BG1};
  border-radius: 40px;
