...
`,nr=b.lazy(()=>De(()=>import("./index-df713886.js"),["assets/index-df713886.js","assets/index-2994430f.js","assets/index-b4d03b7b.css","assets/index-7824c2b2.js","assets/SourcesTableIcon-99793f8d.js","assets/index-f62b0b4a.js","assets/CheckIcon-085d17bb.js","assets/DeleteNodeIcon-87d9c9a9.js","assets/SoundIcon-5f345156.js","assets/SucessFeedBackIcon-5672a4b9.js","assets/ClipLoader-b7182946.js","assets/TableRow-4b108d34.js"]).then(({TweetAnalyze:e})=>({default:e}))),ir=()=>{const e=$(p=>p.setSelectedTweet),t=$(p=>p.selectedTweet),{tweetId:a}=ge(),[r,n]=b.useState(""),{open:i}=Re("tweetAnalyze"),l=(a==null?void 0:a.split("&"))||[],o=p=>{i(),n(p)};return s.jsx(s.Fragment,{children:s.jsxs(sr,{align:"stretch",basis:"100%",grow:1,shrink:1,children:[l.length>1?s.jsx(ar,{onClick:()=>{o("summary")},children:"Summary Report"}):null,l.map(p=>s.jsx(or,{className:t===p?"selected":"",onClick:()=>e(p),children:s.jsx(Vt,{handleAnalyzeClick:()=>{o(p)},nodeId:p})},p)),s.jsx(nr,{tweetId:r})]})})},ar=h.button`
  width: 100%;
  background: ${y.ANALYTICS_CARD_BG};
  color: ${y.white};
  padding: 16px 16px;
