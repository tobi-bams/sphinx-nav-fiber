import{r as o,j as e,s as h,g as k,F as j,o as J,c as K,A as ae,p as ce,i as le,q as pe,H as de,t as ue,v as X}from"./index-88d69002.js";import{t as V,u as H,C as fe}from"./index-0fa087ab.js";import{U as me}from"./index-ee6235c2.js";import{u as B,a as ge,b as he,I as xe,c as Q,d as ye}from"./index-f8772034.js";import{M as be,V as we}from"./index-91b65bcc.js";import{S as je,R as ve,s as L,M as ke}from"./index-bcab575a.js";import"./string-a277709d.js";import"./index-ffa3dde8.js";import"./three.module-9722a9fc.js";import"./index-0009b7d4.js";import"./TextareaAutosize-828f4bf7.js";import"./CheckIcon-9d0125c1.js";import"./index-467a87a8.js";import"./index-d5c4bc26.js";import"./ClipLoader-981ef4d7.js";import"./clsx-7c9e893f.js";import"./SourcesTableIcon-c0bffa87.js";import"./DeleteNodeIcon-edda7cec.js";import"./SoundIcon-3805f8a3.js";import"./SucessFeedBackIcon-15287a7b.js";import"./Skeleton-d1b42aba.js";import"./index-7b642247.js";import"./Stack-7559f8e3.js";import"./FormControlLabel-e3c17a5d.js";import"./Typography-d1508f57.js";import"./createSvgIcon-967b405a.js";import"./isPlainObject-8f5f0e0e.js";const Z=o.memo(()=>{const s=B(r=>r.isPlaying),i=B(r=>r.setIsPlaying),n=B(r=>r.setVolume),t=B(r=>r.setPlaybackSpeed),a=B(r=>r.playbackSpeed),c=B(r=>r.playerRef),[f,m]=o.useState(!1),p=[.5,1,1.5,2],y=()=>{if(c){const r=c.getCurrentTime()-15;c.seekTo(r,"seconds")}},g=()=>{if(c){const r=c.getCurrentTime()+15;c.seekTo(r,"seconds")}},b=()=>{i(!s)},d=()=>{m(!f),n(f?1:0)},x=()=>{const u=(p.indexOf(a)+1)%p.length,w=p[u];if(t(w),c){const v=c.getInternalPlayer();v&&typeof v.playbackRate<"u"&&(v.playbackRate=w)}};return e.jsxs(Ce,{children:[e.jsx(Pe,{onClick:d,children:f?e.jsx(be,{}):e.jsx(we,{})}),e.jsx(_e,{onClick:y,children:e.jsx("img",{alt:"",src:"/RewindIcon.svg"})}),e.jsx(Se,{"data-testid":"play-pause-button",onClick:b,size:"small",children:s?e.jsx(ge,{"data-testid":"pause-icon"}):e.jsx(he,{"data-testid":"play-icon"})}),e.jsx(Ie,{onClick:g,children:e.jsx("img",{alt:"",src:"/ForwardIcon.svg"})}),e.jsxs(Ee,{onClick:x,children:[a,"x"]})]})});Z.displayName="Controls";const Ce=h(j).attrs({direction:"row",align:"center",justify:"flex-start"})`
  width: 200px;
  height: 54px;
  background: ${k.BG1};
  border-radius: 40px;
