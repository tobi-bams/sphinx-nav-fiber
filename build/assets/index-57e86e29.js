...
`,nr=b.lazy(()=>De(()=>import("./index-c81937d4.js"),["assets/index-c81937d4.js","assets/index-1069599b.js","assets/index-b4d03b7b.css","assets/index-aac187bb.js","assets/SourcesTableIcon-cfb8bbef.js","assets/index-3a4c6a5d.js","assets/CheckIcon-60d18cda.js","assets/DeleteNodeIcon-9b22b01b.js","assets/SoundIcon-12d100ca.js","assets/SucessFeedBackIcon-f65531e7.js","assets/ClipLoader-015e7281.js","assets/TableRow-6d5572b9.js"]).then(({TweetAnalyze:e})=>({default:e}))),ir=()=>{const e=$(p=>p.setSelectedTweet),t=$(p=>p.selectedTweet),{tweetId:a}=ge(),[r,n]=b.useState(""),{open:i}=Re("tweetAnalyze"),l=(a==null?void 0:a.split("&"))||[],o=p=>{i(),n(p)};return s.jsx(s.Fragment,{children:s.jsxs(sr,{align:"stretch",basis:"100%",grow:1,shrink:1,children:[l.length>1?s.jsx(ar,{onClick:()=>{o("summary")},children:"Summary Report"}):null,l.map(p=>s.jsx(or,{className:t===p?"selected":"",onClick:()=>e(p),children:s.jsx(Vt,{handleAnalyzeClick:()=>{o(p)},nodeId:p})},p)),s.jsx(nr,{tweetId:r})]})})},ar=h.button`
  width: 100%;
  background: ${y.ANALYTICS_CARD_BG};
  color: ${y.white};
  padding: 16px 16px;
