...
`,nr=b.lazy(()=>De(()=>import("./index-60872bfb.js"),["assets/index-60872bfb.js","assets/index-8f2026e5.js","assets/index-b4d03b7b.css","assets/index-ef010333.js","assets/SourcesTableIcon-b3d529b2.js","assets/index-4de5a9e4.js","assets/CheckIcon-dd322c93.js","assets/DeleteNodeIcon-9ab6e8f2.js","assets/SoundIcon-b108644e.js","assets/SucessFeedBackIcon-af2fb8ec.js","assets/ClipLoader-465d0745.js","assets/TableRow-6fe42746.js"]).then(({TweetAnalyze:e})=>({default:e}))),ir=()=>{const e=$(p=>p.setSelectedTweet),t=$(p=>p.selectedTweet),{tweetId:a}=ge(),[r,n]=b.useState(""),{open:i}=Re("tweetAnalyze"),l=(a==null?void 0:a.split("&"))||[],o=p=>{i(),n(p)};return s.jsx(s.Fragment,{children:s.jsxs(sr,{align:"stretch",basis:"100%",grow:1,shrink:1,children:[l.length>1?s.jsx(ar,{onClick:()=>{o("summary")},children:"Summary Report"}):null,l.map(p=>s.jsx(or,{className:t===p?"selected":"",onClick:()=>e(p),children:s.jsx(Vt,{handleAnalyzeClick:()=>{o(p)},nodeId:p})},p)),s.jsx(nr,{tweetId:r})]})})},ar=h.button`
  width: 100%;
  background: ${y.ANALYTICS_CARD_BG};
  color: ${y.white};
  padding: 16px 16px;
