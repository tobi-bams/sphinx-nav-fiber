import{r as o,j as e,s as h,g as k,F as j,o as J,c as K,A as ae,p as ce,i as le,q as pe,H as de,t as ue,v as X}from"./index-3b64e630.js";import{t as V,u as H,C as fe}from"./index-450b329a.js";import{U as me}from"./index-b6b0ba0c.js";import{u as B,a as ge,b as he,I as xe,c as Q,d as ye}from"./index-1e028270.js";import{M as be,V as we}from"./index-0a668368.js";import{S as je,R as ve,s as L,M as ke}from"./index-b4a13a23.js";import"./string-a277709d.js";import"./index-a8761633.js";import"./three.module-9722a9fc.js";import"./index-094dcced.js";import"./TextareaAutosize-a1ff9ae4.js";import"./CheckIcon-33fc346e.js";import"./index-0e162ebc.js";import"./index-97edd381.js";import"./ClipLoader-69fba704.js";import"./clsx-a96191de.js";import"./SourcesTableIcon-d32531cd.js";import"./DeleteNodeIcon-5e4b34ec.js";import"./SoundIcon-792f7745.js";import"./SucessFeedBackIcon-fc5168f0.js";import"./Skeleton-16f5ab27.js";import"./index-843ab17e.js";import"./Stack-40b24b74.js";import"./FormControlLabel-2ed1a140.js";import"./Typography-241d9ebd.js";import"./createSvgIcon-cd97ecf1.js";import"./isPlainObject-28abdfa5.js";const Z=o.memo(()=>{const s=B(r=>r.isPlaying),i=B(r=>r.setIsPlaying),n=B(r=>r.setVolume),t=B(r=>r.setPlaybackSpeed),a=B(r=>r.playbackSpeed),c=B(r=>r.playerRef),[f,m]=o.useState(!1),p=[.5,1,1.5,2],y=()=>{if(c){const r=c.getCurrentTime()-15;c.seekTo(r,"seconds")}},g=()=>{if(c){const r=c.getCurrentTime()+15;c.seekTo(r,"seconds")}},b=()=>{i(!s)},d=()=>{m(!f),n(f?1:0)},x=()=>{const u=(p.indexOf(a)+1)%p.length,w=p[u];if(t(w),c){const v=c.getInternalPlayer();v&&typeof v.playbackRate<"u"&&(v.playbackRate=w)}};return e.jsxs(Ce,{children:[e.jsx(Pe,{onClick:d,children:f?e.jsx(be,{}):e.jsx(we,{})}),e.jsx(_e,{onClick:y,children:e.jsx("img",{alt:"",src:"/RewindIcon.svg"})}),e.jsx(Se,{"data-testid":"play-pause-button",onClick:b,size:"small",children:s?e.jsx(ge,{"data-testid":"pause-icon"}):e.jsx(he,{"data-testid":"play-icon"})}),e.jsx(Ie,{onClick:g,children:e.jsx("img",{alt:"",src:"/ForwardIcon.svg"})}),e.jsxs(Ee,{onClick:x,children:[a,"x"]})]})});Z.displayName="Controls";const Ce=h(j).attrs({direction:"row",align:"center",justify:"flex-start"})`
  width: 200px;
  height: 54px;
  background: ${k.BG1};
  border-radius: 40px;
