import{r as o,j as e,s as h,g as k,F as j,o as J,c as K,A as ae,p as ce,i as le,q as pe,H as de,t as ue,v as X}from"./index-1754ba70.js";import{t as V,u as H,C as fe}from"./index-6d1e097e.js";import{U as me}from"./index-fd3c4201.js";import{u as B,a as ge,b as he,I as xe,c as Q,d as ye}from"./index-ec647c1d.js";import{M as be,V as we}from"./index-2968a713.js";import{S as je,R as ve,s as L,M as ke}from"./index-d7fcd34a.js";import"./string-a277709d.js";import"./index-f6a53b44.js";import"./three.module-9722a9fc.js";import"./index-656b6735.js";import"./TextareaAutosize-f1beb2b0.js";import"./CheckIcon-4bf98e31.js";import"./index-1e759a34.js";import"./index-494e7310.js";import"./ClipLoader-54f88294.js";import"./clsx-dae6b1fe.js";import"./SourcesTableIcon-35621de5.js";import"./DeleteNodeIcon-dad7ecc0.js";import"./SoundIcon-6088bb66.js";import"./SucessFeedBackIcon-ce29c4db.js";import"./Skeleton-55d39ba9.js";import"./index-22e6d9f5.js";import"./Stack-285b7f84.js";import"./FormControlLabel-36689c5b.js";import"./Typography-346fa008.js";import"./createSvgIcon-9e92b0b5.js";import"./isPlainObject-f2acbf4f.js";const Z=o.memo(()=>{const s=B(r=>r.isPlaying),i=B(r=>r.setIsPlaying),n=B(r=>r.setVolume),t=B(r=>r.setPlaybackSpeed),a=B(r=>r.playbackSpeed),c=B(r=>r.playerRef),[f,m]=o.useState(!1),p=[.5,1,1.5,2],y=()=>{if(c){const r=c.getCurrentTime()-15;c.seekTo(r,"seconds")}},g=()=>{if(c){const r=c.getCurrentTime()+15;c.seekTo(r,"seconds")}},b=()=>{i(!s)},d=()=>{m(!f),n(f?1:0)},x=()=>{const u=(p.indexOf(a)+1)%p.length,w=p[u];if(t(w),c){const v=c.getInternalPlayer();v&&typeof v.playbackRate<"u"&&(v.playbackRate=w)}};return e.jsxs(Ce,{children:[e.jsx(Pe,{onClick:d,children:f?e.jsx(be,{}):e.jsx(we,{})}),e.jsx(_e,{onClick:y,children:e.jsx("img",{alt:"",src:"/RewindIcon.svg"})}),e.jsx(Se,{"data-testid":"play-pause-button",onClick:b,size:"small",children:s?e.jsx(ge,{"data-testid":"pause-icon"}):e.jsx(he,{"data-testid":"play-icon"})}),e.jsx(Ie,{onClick:g,children:e.jsx("img",{alt:"",src:"/ForwardIcon.svg"})}),e.jsxs(Ee,{onClick:x,children:[a,"x"]})]})});Z.displayName="Controls";const Ce=h(j).attrs({direction:"row",align:"center",justify:"flex-start"})`
  width: 200px;
  height: 54px;
  background: ${k.BG1};
  border-radius: 40px;
