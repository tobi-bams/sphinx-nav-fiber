...
`,nr=b.lazy(()=>De(()=>import("./index-37fc9eab.js"),["assets/index-37fc9eab.js","assets/index-ed6a3f3e.js","assets/index-b4d03b7b.css","assets/index-9dc1bac9.js","assets/SourcesTableIcon-3553f47d.js","assets/index-5039cdd5.js","assets/CheckIcon-7fcad07d.js","assets/DeleteNodeIcon-4e9e83ff.js","assets/SoundIcon-9731d8d6.js","assets/SucessFeedBackIcon-de294afd.js","assets/ClipLoader-e1f47cb2.js","assets/TableRow-d2362881.js"]).then(({TweetAnalyze:e})=>({default:e}))),ir=()=>{const e=$(p=>p.setSelectedTweet),t=$(p=>p.selectedTweet),{tweetId:a}=ge(),[r,n]=b.useState(""),{open:i}=Re("tweetAnalyze"),l=(a==null?void 0:a.split("&"))||[],o=p=>{i(),n(p)};return s.jsx(s.Fragment,{children:s.jsxs(sr,{align:"stretch",basis:"100%",grow:1,shrink:1,children:[l.length>1?s.jsx(ar,{onClick:()=>{o("summary")},children:"Summary Report"}):null,l.map(p=>s.jsx(or,{className:t===p?"selected":"",onClick:()=>e(p),children:s.jsx(Vt,{handleAnalyzeClick:()=>{o(p)},nodeId:p})},p)),s.jsx(nr,{tweetId:r})]})})},ar=h.button`
  width: 100%;
  background: ${y.ANALYTICS_CARD_BG};
  color: ${y.white};
  padding: 16px 16px;
