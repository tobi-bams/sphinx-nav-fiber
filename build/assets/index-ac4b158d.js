...
`,nr=b.lazy(()=>De(()=>import("./index-01823eca.js"),["assets/index-01823eca.js","assets/index-4ba529fc.js","assets/index-b4d03b7b.css","assets/index-ed2ed819.js","assets/SourcesTableIcon-395455b8.js","assets/index-2d397c8e.js","assets/CheckIcon-d816993a.js","assets/DeleteNodeIcon-a5d96c7b.js","assets/SoundIcon-26ffb456.js","assets/SucessFeedBackIcon-f2f77fda.js","assets/ClipLoader-9d41b8c6.js","assets/TableRow-d8beadb1.js"]).then(({TweetAnalyze:e})=>({default:e}))),ir=()=>{const e=$(p=>p.setSelectedTweet),t=$(p=>p.selectedTweet),{tweetId:a}=ge(),[r,n]=b.useState(""),{open:i}=Re("tweetAnalyze"),l=(a==null?void 0:a.split("&"))||[],o=p=>{i(),n(p)};return s.jsx(s.Fragment,{children:s.jsxs(sr,{align:"stretch",basis:"100%",grow:1,shrink:1,children:[l.length>1?s.jsx(ar,{onClick:()=>{o("summary")},children:"Summary Report"}):null,l.map(p=>s.jsx(or,{className:t===p?"selected":"",onClick:()=>e(p),children:s.jsx(Vt,{handleAnalyzeClick:()=>{o(p)},nodeId:p})},p)),s.jsx(nr,{tweetId:r})]})})},ar=h.button`
  width: 100%;
  background: ${y.ANALYTICS_CARD_BG};
  color: ${y.white};
  padding: 16px 16px;
