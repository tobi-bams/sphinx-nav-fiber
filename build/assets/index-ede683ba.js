...
`,nr=b.lazy(()=>De(()=>import("./index-c7fecb04.js"),["assets/index-c7fecb04.js","assets/index-b4348ca1.js","assets/index-b4d03b7b.css","assets/index-e6ebe5b0.js","assets/SourcesTableIcon-d0cea899.js","assets/index-e0c62e83.js","assets/CheckIcon-9ac1fdc1.js","assets/DeleteNodeIcon-71e07447.js","assets/SoundIcon-c6bd68b8.js","assets/SucessFeedBackIcon-026250ce.js","assets/ClipLoader-fe2c69dc.js","assets/TableRow-8a287160.js"]).then(({TweetAnalyze:e})=>({default:e}))),ir=()=>{const e=$(p=>p.setSelectedTweet),t=$(p=>p.selectedTweet),{tweetId:a}=ge(),[r,n]=b.useState(""),{open:i}=Re("tweetAnalyze"),l=(a==null?void 0:a.split("&"))||[],o=p=>{i(),n(p)};return s.jsx(s.Fragment,{children:s.jsxs(sr,{align:"stretch",basis:"100%",grow:1,shrink:1,children:[l.length>1?s.jsx(ar,{onClick:()=>{o("summary")},children:"Summary Report"}):null,l.map(p=>s.jsx(or,{className:t===p?"selected":"",onClick:()=>e(p),children:s.jsx(Vt,{handleAnalyzeClick:()=>{o(p)},nodeId:p})},p)),s.jsx(nr,{tweetId:r})]})})},ar=h.button`
  width: 100%;
  background: ${y.ANALYTICS_CARD_BG};
  color: ${y.white};
  padding: 16px 16px;
