import{r as o,j as e,s as h,g as k,F as j,o as J,c as K,A as ae,p as ce,i as le,q as pe,H as de,t as ue,v as X}from"./index-ed6a3f3e.js";import{t as V,u as H,C as fe}from"./index-e01518a4.js";import{U as me}from"./index-a09f4f84.js";import{u as B,a as ge,b as he,I as xe,c as Q,d as ye}from"./index-5039cdd5.js";import{M as be,V as we}from"./index-9dc1bac9.js";import{S as je,R as ve,s as L,M as ke}from"./index-95db7518.js";import"./string-a277709d.js";import"./index-f28b47bd.js";import"./three.module-9722a9fc.js";import"./index-272d12ff.js";import"./TextareaAutosize-5fec1fb5.js";import"./CheckIcon-7fcad07d.js";import"./index-1710acb8.js";import"./index-eb6d03ab.js";import"./ClipLoader-e1f47cb2.js";import"./clsx-ee984d51.js";import"./SourcesTableIcon-3553f47d.js";import"./DeleteNodeIcon-4e9e83ff.js";import"./SoundIcon-9731d8d6.js";import"./SucessFeedBackIcon-de294afd.js";import"./Skeleton-efa6ce13.js";import"./index-dc602526.js";import"./Stack-dcf9700c.js";import"./FormControlLabel-c4bf04ab.js";import"./Typography-4d118673.js";import"./createSvgIcon-2ebd4f20.js";import"./isPlainObject-4ca15a78.js";const Z=o.memo(()=>{const s=B(r=>r.isPlaying),i=B(r=>r.setIsPlaying),n=B(r=>r.setVolume),t=B(r=>r.setPlaybackSpeed),a=B(r=>r.playbackSpeed),c=B(r=>r.playerRef),[f,m]=o.useState(!1),p=[.5,1,1.5,2],y=()=>{if(c){const r=c.getCurrentTime()-15;c.seekTo(r,"seconds")}},g=()=>{if(c){const r=c.getCurrentTime()+15;c.seekTo(r,"seconds")}},b=()=>{i(!s)},d=()=>{m(!f),n(f?1:0)},x=()=>{const u=(p.indexOf(a)+1)%p.length,w=p[u];if(t(w),c){const v=c.getInternalPlayer();v&&typeof v.playbackRate<"u"&&(v.playbackRate=w)}};return e.jsxs(Ce,{children:[e.jsx(Pe,{onClick:d,children:f?e.jsx(be,{}):e.jsx(we,{})}),e.jsx(_e,{onClick:y,children:e.jsx("img",{alt:"",src:"/RewindIcon.svg"})}),e.jsx(Se,{"data-testid":"play-pause-button",onClick:b,size:"small",children:s?e.jsx(ge,{"data-testid":"pause-icon"}):e.jsx(he,{"data-testid":"play-icon"})}),e.jsx(Ie,{onClick:g,children:e.jsx("img",{alt:"",src:"/ForwardIcon.svg"})}),e.jsxs(Ee,{onClick:x,children:[a,"x"]})]})});Z.displayName="Controls";const Ce=h(j).attrs({direction:"row",align:"center",justify:"flex-start"})`
  width: 200px;
  height: 54px;
  background: ${k.BG1};
  border-radius: 40px;
