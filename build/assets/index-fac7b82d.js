...
`,nr=b.lazy(()=>De(()=>import("./index-fad3a941.js"),["assets/index-fad3a941.js","assets/index-3b64e630.js","assets/index-b4d03b7b.css","assets/index-0a668368.js","assets/SourcesTableIcon-d32531cd.js","assets/index-1e028270.js","assets/CheckIcon-33fc346e.js","assets/DeleteNodeIcon-5e4b34ec.js","assets/SoundIcon-792f7745.js","assets/SucessFeedBackIcon-fc5168f0.js","assets/ClipLoader-69fba704.js","assets/TableRow-883bef87.js"]).then(({TweetAnalyze:e})=>({default:e}))),ir=()=>{const e=$(p=>p.setSelectedTweet),t=$(p=>p.selectedTweet),{tweetId:a}=ge(),[r,n]=b.useState(""),{open:i}=Re("tweetAnalyze"),l=(a==null?void 0:a.split("&"))||[],o=p=>{i(),n(p)};return s.jsx(s.Fragment,{children:s.jsxs(sr,{align:"stretch",basis:"100%",grow:1,shrink:1,children:[l.length>1?s.jsx(ar,{onClick:()=>{o("summary")},children:"Summary Report"}):null,l.map(p=>s.jsx(or,{className:t===p?"selected":"",onClick:()=>e(p),children:s.jsx(Vt,{handleAnalyzeClick:()=>{o(p)},nodeId:p})},p)),s.jsx(nr,{tweetId:r})]})})},ar=h.button`
  width: 100%;
  background: ${y.ANALYTICS_CARD_BG};
  color: ${y.white};
  padding: 16px 16px;
