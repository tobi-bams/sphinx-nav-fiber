import{r as o,j as e,s as h,g as k,F as j,o as J,c as K,A as ae,p as ce,i as le,q as pe,H as de,t as ue,v as X}from"./index-8a9233db.js";import{t as V,u as H,C as fe}from"./index-c3dd6646.js";import{U as me}from"./index-6569f5ba.js";import{u as B,a as ge,b as he,I as xe,c as Q,d as ye}from"./index-94ffae3e.js";import{M as be,V as we}from"./index-98a12afa.js";import{S as je,R as ve,s as L,M as ke}from"./index-3245d4cf.js";import"./string-a277709d.js";import"./index-8553770c.js";import"./three.module-9722a9fc.js";import"./index-6411c506.js";import"./TextareaAutosize-2f67f58f.js";import"./CheckIcon-204c1c5a.js";import"./index-710f094e.js";import"./index-847e80e5.js";import"./ClipLoader-e478eed9.js";import"./clsx-07f78e5f.js";import"./SourcesTableIcon-18286c79.js";import"./DeleteNodeIcon-2c6d83a7.js";import"./SoundIcon-c16f657f.js";import"./SucessFeedBackIcon-9c6aa925.js";import"./Skeleton-e310bcdc.js";import"./index-95ce86fd.js";import"./Stack-90c65f8b.js";import"./FormControlLabel-506d7643.js";import"./Typography-5e1b499f.js";import"./createSvgIcon-f1d16aac.js";import"./isPlainObject-f7ded684.js";const Z=o.memo(()=>{const s=B(r=>r.isPlaying),i=B(r=>r.setIsPlaying),n=B(r=>r.setVolume),t=B(r=>r.setPlaybackSpeed),a=B(r=>r.playbackSpeed),c=B(r=>r.playerRef),[f,m]=o.useState(!1),p=[.5,1,1.5,2],y=()=>{if(c){const r=c.getCurrentTime()-15;c.seekTo(r,"seconds")}},g=()=>{if(c){const r=c.getCurrentTime()+15;c.seekTo(r,"seconds")}},b=()=>{i(!s)},d=()=>{m(!f),n(f?1:0)},x=()=>{const u=(p.indexOf(a)+1)%p.length,w=p[u];if(t(w),c){const v=c.getInternalPlayer();v&&typeof v.playbackRate<"u"&&(v.playbackRate=w)}};return e.jsxs(Ce,{children:[e.jsx(Pe,{onClick:d,children:f?e.jsx(be,{}):e.jsx(we,{})}),e.jsx(_e,{onClick:y,children:e.jsx("img",{alt:"",src:"/RewindIcon.svg"})}),e.jsx(Se,{"data-testid":"play-pause-button",onClick:b,size:"small",children:s?e.jsx(ge,{"data-testid":"pause-icon"}):e.jsx(he,{"data-testid":"play-icon"})}),e.jsx(Ie,{onClick:g,children:e.jsx("img",{alt:"",src:"/ForwardIcon.svg"})}),e.jsxs(Ee,{onClick:x,children:[a,"x"]})]})});Z.displayName="Controls";const Ce=h(j).attrs({direction:"row",align:"center",justify:"flex-start"})`
  width: 200px;
  height: 54px;
  background: ${k.BG1};
  border-radius: 40px;
