...
`,nr=b.lazy(()=>De(()=>import("./index-9c7edd28.js"),["assets/index-9c7edd28.js","assets/index-88d69002.js","assets/index-b4d03b7b.css","assets/index-91b65bcc.js","assets/SourcesTableIcon-c0bffa87.js","assets/index-f8772034.js","assets/CheckIcon-9d0125c1.js","assets/DeleteNodeIcon-edda7cec.js","assets/SoundIcon-3805f8a3.js","assets/SucessFeedBackIcon-15287a7b.js","assets/ClipLoader-981ef4d7.js","assets/TableRow-32e3873c.js"]).then(({TweetAnalyze:e})=>({default:e}))),ir=()=>{const e=$(p=>p.setSelectedTweet),t=$(p=>p.selectedTweet),{tweetId:a}=ge(),[r,n]=b.useState(""),{open:i}=Re("tweetAnalyze"),l=(a==null?void 0:a.split("&"))||[],o=p=>{i(),n(p)};return s.jsx(s.Fragment,{children:s.jsxs(sr,{align:"stretch",basis:"100%",grow:1,shrink:1,children:[l.length>1?s.jsx(ar,{onClick:()=>{o("summary")},children:"Summary Report"}):null,l.map(p=>s.jsx(or,{className:t===p?"selected":"",onClick:()=>e(p),children:s.jsx(Vt,{handleAnalyzeClick:()=>{o(p)},nodeId:p})},p)),s.jsx(nr,{tweetId:r})]})})},ar=h.button`
  width: 100%;
  background: ${y.ANALYTICS_CARD_BG};
  color: ${y.white};
  padding: 16px 16px;
