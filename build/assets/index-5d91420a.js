import{s as c,g as N,T as D,F as s,D as x,k as W,r as d,j as e,b2 as k,b3 as P,l as V,c as G,n as q,B as _,bC as H,bD as Y,b5 as J}from"./index-1069599b.js";import{e as F}from"./index-3a4c6a5d.js";import{T as K,a0 as Q}from"./index-aac187bb.js";import{S as X}from"./Skeleton-b1b2bf3e.js";import{C as Z}from"./ClipLoader-015e7281.js";import"./SourcesTableIcon-cfb8bbef.js";import"./CheckIcon-60d18cda.js";import"./DeleteNodeIcon-9b22b01b.js";import"./SoundIcon-12d100ca.js";import"./SucessFeedBackIcon-f65531e7.js";const ee=/^https:\/\/\S+\.(png|jpe?g|svg)$/;function te(i){return!!ee.test(i)}function oe(i){return i.split("_").map(p=>p.charAt(0).toUpperCase()+p.slice(1)).join(" ")}const ae=()=>{const{open:i}=x("changeNodeType"),{close:p}=x("editNodeName"),{changeNodeTypeFeatureFlag:y}=W(a=>({changeNodeTypeFeatureFlag:a.changeNodeTypeFeatureFlag})),o=F(),j=o==null?void 0:o.node_type,[m,g]=d.useState({});d.useEffect(()=>{o!=null&&o.properties&&g(o.properties)},[o]);const b=()=>{p(),i()},h=(a,n)=>{g(C=>({...C,[a]:n}))};return e.jsxs(s,{children:[e.jsx(s,{align:"center",direction:"row",justify:"space-between",mb:18,children:e.jsxs(s,{align:"center",direction:"row",children:[e.jsx(ne,{children:"Edit Node"}),e.jsxs(se,{children:[e.jsx(K,{type:j}),y&&e.jsx(ie,{onClick:b,children:e.jsx(Q,{})})]})]})}),e.jsx(ce,{children:Object.keys(m).map(a=>e.jsxs(s,{mb:18,children:[e.jsx(re,{style:{marginBottom:8},children:oe(a)}),e.jsx(k,{id:`cy-${a}`,maxLength:50,name:`properties.${a}`,onChange:n=>h(a,n),placeholder:`Please Enter the ${a}`,rules:a==="name"?{...P}:{}})]},a))})]})},ne=c(D)`
  font-size: 22px;
  font-weight: 600;
  font-family: 'Barlow';
`,re=c(D)`
