...
`,nr=b.lazy(()=>De(()=>import("./index-65eb7957.js"),["assets/index-65eb7957.js","assets/index-bae22255.js","assets/index-b4d03b7b.css","assets/index-7b080110.js","assets/SourcesTableIcon-e5c2dfc8.js","assets/index-348c15e4.js","assets/CheckIcon-c24f120e.js","assets/DeleteNodeIcon-8cc0bcdf.js","assets/SoundIcon-f7e1e16d.js","assets/SucessFeedBackIcon-d67a460b.js","assets/ClipLoader-c31574b7.js","assets/TableRow-1c0d94cc.js"]).then(({TweetAnalyze:e})=>({default:e}))),ir=()=>{const e=$(p=>p.setSelectedTweet),t=$(p=>p.selectedTweet),{tweetId:a}=ge(),[r,n]=b.useState(""),{open:i}=Re("tweetAnalyze"),l=(a==null?void 0:a.split("&"))||[],o=p=>{i(),n(p)};return s.jsx(s.Fragment,{children:s.jsxs(sr,{align:"stretch",basis:"100%",grow:1,shrink:1,children:[l.length>1?s.jsx(ar,{onClick:()=>{o("summary")},children:"Summary Report"}):null,l.map(p=>s.jsx(or,{className:t===p?"selected":"",onClick:()=>e(p),children:s.jsx(Vt,{handleAnalyzeClick:()=>{o(p)},nodeId:p})},p)),s.jsx(nr,{tweetId:r})]})})},ar=h.button`
  width: 100%;
  background: ${y.ANALYTICS_CARD_BG};
  color: ${y.white};
  padding: 16px 16px;
