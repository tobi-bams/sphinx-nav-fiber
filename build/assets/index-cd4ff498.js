...
`,nr=b.lazy(()=>De(()=>import("./index-7795e30e.js"),["assets/index-7795e30e.js","assets/index-b5f1b91b.js","assets/index-b4d03b7b.css","assets/index-90162213.js","assets/SourcesTableIcon-a3e8ced4.js","assets/index-47de5187.js","assets/CheckIcon-0fc14237.js","assets/DeleteNodeIcon-d05bbe40.js","assets/SoundIcon-3fb82c5b.js","assets/SucessFeedBackIcon-c7853a87.js","assets/ClipLoader-b254fccd.js","assets/TableRow-08a5c36f.js"]).then(({TweetAnalyze:e})=>({default:e}))),ir=()=>{const e=$(p=>p.setSelectedTweet),t=$(p=>p.selectedTweet),{tweetId:a}=ge(),[r,n]=b.useState(""),{open:i}=Re("tweetAnalyze"),l=(a==null?void 0:a.split("&"))||[],o=p=>{i(),n(p)};return s.jsx(s.Fragment,{children:s.jsxs(sr,{align:"stretch",basis:"100%",grow:1,shrink:1,children:[l.length>1?s.jsx(ar,{onClick:()=>{o("summary")},children:"Summary Report"}):null,l.map(p=>s.jsx(or,{className:t===p?"selected":"",onClick:()=>e(p),children:s.jsx(Vt,{handleAnalyzeClick:()=>{o(p)},nodeId:p})},p)),s.jsx(nr,{tweetId:r})]})})},ar=h.button`
  width: 100%;
  background: ${y.ANALYTICS_CARD_BG};
  color: ${y.white};
  padding: 16px 16px;
