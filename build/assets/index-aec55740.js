import{r as o,j as e,s as h,g as k,F as j,o as J,c as K,A as ae,p as ce,i as le,q as pe,H as de,t as ue,v as X}from"./index-4ba529fc.js";import{t as V,u as H,C as fe}from"./index-0c04b01b.js";import{U as me}from"./index-4d8a8b57.js";import{u as B,a as ge,b as he,I as xe,c as Q,d as ye}from"./index-2d397c8e.js";import{M as be,V as we}from"./index-ed2ed819.js";import{S as je,R as ve,s as L,M as ke}from"./index-25c6ac19.js";import"./string-a277709d.js";import"./index-e3dc7782.js";import"./three.module-9722a9fc.js";import"./index-9a6a2ecf.js";import"./TextareaAutosize-09d1c7d9.js";import"./CheckIcon-d816993a.js";import"./index-541686a4.js";import"./index-4e85d8ba.js";import"./ClipLoader-9d41b8c6.js";import"./clsx-22b5d666.js";import"./SourcesTableIcon-395455b8.js";import"./DeleteNodeIcon-a5d96c7b.js";import"./SoundIcon-26ffb456.js";import"./SucessFeedBackIcon-f2f77fda.js";import"./Skeleton-dbf311f8.js";import"./index-d50951b3.js";import"./Stack-c7adc00c.js";import"./FormControlLabel-a47d6c93.js";import"./Typography-b991d9cf.js";import"./createSvgIcon-7393ca0f.js";import"./isPlainObject-6dec385f.js";const Z=o.memo(()=>{const s=B(r=>r.isPlaying),i=B(r=>r.setIsPlaying),n=B(r=>r.setVolume),t=B(r=>r.setPlaybackSpeed),a=B(r=>r.playbackSpeed),c=B(r=>r.playerRef),[f,m]=o.useState(!1),p=[.5,1,1.5,2],y=()=>{if(c){const r=c.getCurrentTime()-15;c.seekTo(r,"seconds")}},g=()=>{if(c){const r=c.getCurrentTime()+15;c.seekTo(r,"seconds")}},b=()=>{i(!s)},d=()=>{m(!f),n(f?1:0)},x=()=>{const u=(p.indexOf(a)+1)%p.length,w=p[u];if(t(w),c){const v=c.getInternalPlayer();v&&typeof v.playbackRate<"u"&&(v.playbackRate=w)}};return e.jsxs(Ce,{children:[e.jsx(Pe,{onClick:d,children:f?e.jsx(be,{}):e.jsx(we,{})}),e.jsx(_e,{onClick:y,children:e.jsx("img",{alt:"",src:"/RewindIcon.svg"})}),e.jsx(Se,{"data-testid":"play-pause-button",onClick:b,size:"small",children:s?e.jsx(ge,{"data-testid":"pause-icon"}):e.jsx(he,{"data-testid":"play-icon"})}),e.jsx(Ie,{onClick:g,children:e.jsx("img",{alt:"",src:"/ForwardIcon.svg"})}),e.jsxs(Ee,{onClick:x,children:[a,"x"]})]})});Z.displayName="Controls";const Ce=h(j).attrs({direction:"row",align:"center",justify:"flex-start"})`
  width: 200px;
  height: 54px;
  background: ${k.BG1};
  border-radius: 40px;
