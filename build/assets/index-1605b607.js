import{r as o,j as e,s as h,g as k,F as j,o as J,c as K,A as ae,p as ce,i as le,q as pe,H as de,t as ue,v as X}from"./index-4dff6362.js";import{t as V,u as H,C as fe}from"./index-7c28b7b7.js";import{U as me}from"./index-40de81d3.js";import{u as B,a as ge,b as he,I as xe,c as Q,d as ye}from"./index-f1bc108f.js";import{M as be,V as we}from"./index-742971df.js";import{S as je,R as ve,s as L,M as ke}from"./index-217ac160.js";import"./string-a277709d.js";import"./index-0a993048.js";import"./three.module-9722a9fc.js";import"./index-f4c364e0.js";import"./TextareaAutosize-fb1c398a.js";import"./CheckIcon-3287db9d.js";import"./index-35d09502.js";import"./index-0d579f85.js";import"./ClipLoader-ed6c36df.js";import"./clsx-00c29abd.js";import"./SourcesTableIcon-b20a3388.js";import"./DeleteNodeIcon-3d2d0428.js";import"./SoundIcon-9569b188.js";import"./SucessFeedBackIcon-ca85cac6.js";import"./Skeleton-1131c00b.js";import"./index-201ef993.js";import"./Stack-9fc8ab0f.js";import"./FormControlLabel-62326173.js";import"./Typography-0dafedae.js";import"./createSvgIcon-625ddf5f.js";import"./isPlainObject-81dc8e3d.js";const Z=o.memo(()=>{const s=B(r=>r.isPlaying),i=B(r=>r.setIsPlaying),n=B(r=>r.setVolume),t=B(r=>r.setPlaybackSpeed),a=B(r=>r.playbackSpeed),c=B(r=>r.playerRef),[f,m]=o.useState(!1),p=[.5,1,1.5,2],y=()=>{if(c){const r=c.getCurrentTime()-15;c.seekTo(r,"seconds")}},g=()=>{if(c){const r=c.getCurrentTime()+15;c.seekTo(r,"seconds")}},b=()=>{i(!s)},d=()=>{m(!f),n(f?1:0)},x=()=>{const u=(p.indexOf(a)+1)%p.length,w=p[u];if(t(w),c){const v=c.getInternalPlayer();v&&typeof v.playbackRate<"u"&&(v.playbackRate=w)}};return e.jsxs(Ce,{children:[e.jsx(Pe,{onClick:d,children:f?e.jsx(be,{}):e.jsx(we,{})}),e.jsx(_e,{onClick:y,children:e.jsx("img",{alt:"",src:"/RewindIcon.svg"})}),e.jsx(Se,{"data-testid":"play-pause-button",onClick:b,size:"small",children:s?e.jsx(ge,{"data-testid":"pause-icon"}):e.jsx(he,{"data-testid":"play-icon"})}),e.jsx(Ie,{onClick:g,children:e.jsx("img",{alt:"",src:"/ForwardIcon.svg"})}),e.jsxs(Ee,{onClick:x,children:[a,"x"]})]})});Z.displayName="Controls";const Ce=h(j).attrs({direction:"row",align:"center",justify:"flex-start"})`
  width: 200px;
  height: 54px;
  background: ${k.BG1};
  border-radius: 40px;
